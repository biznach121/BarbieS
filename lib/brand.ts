...
export const brand: Brand = {
  name: "Barbie's Glamour",
  shortName: "Barbie's",
  microTag: "BRINGING OUT YOUR AURA",
  description:
    "Barbie's Glamour is a Kumasi beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0546268410",
    phoneTel: "+233546268410",
    textPhone: "0546268410",
    textPhoneTel: "+233546268410",
    email: "hello@barbies.test",
    privacyEmail: "privacy@barbies.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@barbiesglamour2", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "your aura,\nfully activated.\nBringing out your aura.",
    subtitle:
      "Facials, massage, nails and more in Kumasi — book your treatment today",
  ...
  editorial: {
    ...
    notes: [
      {
        body: "Life in Kumasi rarely leaves room to breathe. The hustle rewards pushing through — and quietly collects the bill from your skin, your back and your sleep.",
        className: "left-[5%] top-[25%] max-w-[330px]",
      },
      {
        body: "That is the gap Barbie's Glamour was built for: honest treatments, fair prices, and a space that treats your time with respect.",
    ...
    images: [
      {
        ...
        alt: "Barbie's Glamour beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Barbie's Glamour self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Barbie's Glamour beauty ritual",
      ...
      },
      {
        ...
        alt: "Barbie's Glamour calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Barbie's Glamour relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Barbie's Glamour beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Barbie's Glamour lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Barbie's Glamour mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Barbie's Glamour makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Barbie's Glamour foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@barbiesglamour2",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783489648/stage4/spa_barbiesglamour2/tiktok_0.mp4",
        alt: "Barbie's Glamour treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783489651/stage4/spa_barbiesglamour2/tiktok_1.mp4",
        alt: "Barbie's Glamour treatment video",
        position: "center",
      },
      {
      ...
      },
      {
        ...
        alt: "Barbie's Glamour studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Barbie's Glamour",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Barbie's Glamour is a curated beauty and self-care space in Kumasi, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Kumasi. Use the Location page for the exact Google Maps pin, or call 0546268410 and text 0546268410 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0546268410, text 0546268410, or message @barbiesglamour2 on Instagram." },
          ...
          { q: "Where are you located?", a: "Barbie's Glamour is in Kumasi. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@barbies.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Barbie's Glamour (\"we\", \"us\") is a beauty and self-care business in Kumasi, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@barbies.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Barbie's Glamour is in Kumasi. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@barbies.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Barbie's Glamour",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0546268410", href: "tel:+233546268410" },
      { label: "Text", value: "0546268410", href: "sms:+233546268410" },
      { label: "Instagram", value: "@barbiesglamour2", href: "https://www.tiktok.com/@barbiesglamour2" },
    ],
  },
  ...
  footer: {
    blurb:
      "Barbie's Glamour in Kumasi — bringing out your aura.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@barbiesglamour2" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0546268410", href: "tel:+233546268410" },
          { label: "Text 0546268410", href: "sms:+233546268410" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Barbie's Glamour — beauty and self-care in Kumasi. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
