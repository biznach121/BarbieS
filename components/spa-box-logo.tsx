...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783489642/stage4/spa_barbiesglamour2/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Barbie's Glamour - Bringing out your aura">
        <Image
          src={src}
          alt="Barbie's Glamour - Bringing out your aura"
          fill
